...
/*$sql =  "SELECT  object. object_id, object. form, object. form_description, class. class_id, class. class_name, class. class_description, group. group_id, group. group_name, group. group_description 
FROM object, class_object_role, class, group_class, group
WHERE object. object_id = class_object_role. object_id
AND class. class_id = class_object_role. class_id
AND class. class_id = group_class. class_id
AND group. group_id = group_class. group_id */

$sql =  "SELECT group. group_id, group. group_name, group. group_description, class. class_id, class. class_name, class. class_description, group_class. group_class_id
FROM group, group_class, class
WHERE group. group_id = group_class. group_id
AND class. class_id = group_class. class_id";
...
if ($result->num_rows > 0) {
     echo "<table><tr><th>group_class_id</th><th>group_id</th><th>class_id</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["group_class_id"]. "</td><td> " . $row["group_id"]. "</td><td> " . $row["class_id"]. "</td></tr>";
